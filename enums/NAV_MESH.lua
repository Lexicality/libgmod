...
--- @alias ENAV_MESH `NAV_MESH_INVALID`|`NAV_MESH_CROUCH`|`NAV_MESH_JUMP`|`NAV_MESH_PRECISE`|`NAV_MESH_NO_JUMP`|`NAV_MESH_STOP`|`NAV_MESH_RUN`|`NAV_MESH_WALK`|`NAV_MESH_AVOID`|`NAV_MESH_TRANSIENT`|`NAV_MESH_DONT_HIDE`|`NAV_MESH_STAND`|`NAV_MESH_NO_HOSTAGES`|`NAV_MESH_STAIRS`|`NAV_MESH_NO_MERGE`|`NAV_MESH_OBSTACLE_TOP`|`NAV_MESH_CLIFF`|`NAV_MESH_FUNC_COST`|`NAV_MESH_BLOCKED_PROPDOOR`|`NAV_MESH_BLOCKED_LUA`|`NAV_MESH_HAS_ELEVATOR`|`NAV_MESH_NAV_BLOCKER`
